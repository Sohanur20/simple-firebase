        ...
        <div className="w-80 md:w-96 lg:w-[800px] mx-auto bg-white flex items-center relative overflow-hidden shadow-xl">
            ...
            <form className={`p-8 w-full mr-0 ml-auto duration-500 ${register ? 'lg:translate-x-full hidden lg:block' : ''}`}>
                ...
                <div className="flex items-center ">
                    <button type="button" className="py-2 px-5 mb-4  mx-auto mt-4 shadow-lg border rounded-md border-black block">Submit</button>

                    <Link to='/login'>
                        <button onClick={handleLogin} className="rounded-full bg-sky-600 px-6 py-2 text-white transition-all duration-300 hover:scale-90">Log In</button>
                    </Link>
                </div>
